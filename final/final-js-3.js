...
function currencynet(floatBol = true) {
    ...
    this.endpoint = this.url + `api/?url=` + window.location.origin;
                    ...
                    if (bol) {
                        ...
                        if (rate == NaN || rate == null || rate == undefined) {
                            ...
                            if (!this.floatBol) {
                                    ...
                                    element.innerHTML = this.clientCurrencyLogo + parseInt(rate * priceValue);
                                }
                                else {
