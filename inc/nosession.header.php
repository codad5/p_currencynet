...
<head>
    ...
    <link rel="stylesheet" href="style/index.css">
    <link rel="stylesheet" href="style/smscreen.css">
...
<script src="https://kit.fontawesome.com/598c5133cc.js" crossorigin="anonymous"></script>
    <!-- <link href="bootstrap/dist/signin.css" rel="stylesheet"> -->
...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top " style='background:#3f4ad1;'>
    <div class="container-fluid">
      <a class="navbar-brand" href="#">C<span style="color:red;">NET</span></a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php#form_signup" >login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php#form_signup" >Signup</a>
          </li>
        </ul>
        <form class="d-flex">
